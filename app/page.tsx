          ...
          <>
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-gray-600 mb-4">
                Write Python, C++, Java with Monaco Editor. Run code with input support.
              </p>
              <button
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-gray-600 mb-4">
                Practice Quantitative, Logical, and Verbal reasoning. Timed tests with explanations.
              </p>
              <button
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-bold mb-2">🚀 More Features Coming Soon</h2>
